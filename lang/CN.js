export default {
	...
	lottery: {
		...
		oddsTable: [" 2% - 钻石鱼x1 + 传说成就", "18% - 大鱼诱饵x1", " 8% - 愚人节：你才是鱼，不是钓鱼人", "21% - 额外金币 +$500", "24% - 额外金币 +$200", " 7% - 大鱼诱饵x2", "20% - 谢谢惠顾"],
		notEnoughBoth: "累计钓鱼数量与金币均不足。抽奖需要累计100条鱼与1000金币。",
		notEnoughFishCount: "累计钓鱼数量不足。抽奖需要累计100条鱼。",
		notEnoughMoney: "金币不足。抽奖需要1000金币。",
		rewardAprilFoolsEgg: "获得愚人节彩蛋x1",
		achievementFishDay: "获得成就: 鱼人节快乐",
		rewardBigFishBait: "大鱼诱饵x1",
		rewardBigFishBait2: "大鱼诱饵x2",
		rewardDiamondFish: "钻石鱼x1",
		achievementLegendaryFish: "获得成就: 传说中的鱼",
		rewardGold500: "额外金币: +$500",
		rewardGold200: "额外金币: +$200",
	...
	fishing: {
		...
		caughtPrefix: "你钓到了一条",
		bigFishPrefix: "大",
		eatenSuffix: "鱼\x1b[m, 因饥饿已食用",
		priceSuffix: "鱼\x1b[m, 价值$",
